          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://facebook.com/mrigaayuvets" target="_blank" rel="noopener noreferrer"
                  className="relative bg-gradient-to-br from-gray-800 to-gray-900 hover:from-blue-600 hover:to-blue-700 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 group border border-gray-700 hover:border-blue-500" title="Facebook">
                ...
                <a href="https://twitter.com/mrigaayuvets" target="_blank" rel="noopener noreferrer"
                  className="relative bg-gradient-to-br from-gray-800 to-gray-900 hover:from-sky-500 hover:to-sky-600 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 group border border-gray-700 hover:border-sky-500" title="Twitter">
                ...
                <a href="https://instagram.com/mrigaayuvets" target="_blank" rel="noopener noreferrer"
                  className="relative bg-gradient-to-br from-gray-800 to-gray-900 hover:from-pink-500 hover:to-purple-600 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 group border border-gray-700 hover:border-pink-500" title="Instagram">
                ...
                <a href="https://wa.me/918208657969" target="_blank" rel="noopener noreferrer"
                  className="relative bg-gradient-to-br from-gray-800 to-gray-900 hover:from-green-500 hover:to-emerald-600 p-3 rounded-xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 group border border-gray-700 hover:border-green-500" title="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { to: '/admin/login', label: 'Admin Login',      icon: 'fa-lock' },  // ← added
              ].map((link, index) => (
                <li key={index}>
                  <Link
                    to={link.to}
      ...
      <div className="relative z-10 border-t border-gray-800 bg-gradient-to-r from-gray-900 via-slate-900 to-gray-900 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-4 text-xs text-gray-600">
            ...
            <Link
              to="/admin/login"
              className="hover:text-blue-400 transition-colors hover:underline flex items-center gap-1"
            >
