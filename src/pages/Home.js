    ...
    <div className="bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-100">
              ...
              <p className="text-gray-700 mb-6 italic leading-relaxed text-sm sm:text-base">
                "Dr. Siddheshwar came to our home within 30 minutes for an emergency. Our Labrador was in distress, and his quick response saved her life. Highly recommend MrigaAayuvets!"
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-800">Khyati Bhinde</h4>
                  <p className="text-sm text-gray-600">Kems corner, Mumbai</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-indigo-100">
              ...
              <p className="text-gray-700 mb-6 italic leading-relaxed text-sm sm:text-base">
                "Best home visit veterinary service in Mumbai! Dr. Siddheshwar is so patient and caring with our dog. The convenience of home treatment is a game-changer!"
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-800">Miss Roshni</h4>
                  <p className="text-sm text-gray-600">Matunga, Mumbai</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-purple-100">
              ...
              <p className="text-gray-700 mb-6 italic leading-relaxed text-sm sm:text-base">
                "Professional, affordable, and genuinely caring. Dr helped our senior dog with mobility issues. The home visit service made such a difference. Thank you!"
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-bold text-gray-800">Miss Bhavna</h4>
                  <p className="text-sm text-gray-600">Tilak nagar, Mumbai</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            ...
            <details className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="px-6 pb-6 text-gray-600 leading-relaxed">
                We serve all areas of Mumbai including Andheri, Bandra, Dadar, Worli, Goregaon, Versova, Tilak nagar, Santacruz, Juhu,  Vile Parle, sion, Mahim, Matunga, Marines, Byculla, Chembur, kems corner, and more.
              </div>
            </details>
      ...
      <section id="contact" className="py-16 sm:py-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">Contact Veterinary Care Mumbai 📞</h2>
